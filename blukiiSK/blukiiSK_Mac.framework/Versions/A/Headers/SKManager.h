 ...
 * @see SKManagerAuthenticationStates
 */
-(void)SKManagerDidUpdateButtonState:(SmartKeyButtonStates)state;
...
-(SKManagerStatusCodes)setLimitedAdvertising:(uint16_t) seconds;


-(SKManagerStatusCodes)setUnlimitedAdvertising;
